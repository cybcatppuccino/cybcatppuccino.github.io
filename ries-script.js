    ...
    function log10MagnitudeAny(x){
      ...
      if(typeof x==='bigint'){
        ...
        if(str==='0') return 0;
        // v10.6 bugfix: the previous large-integer approximation was also
    ...
    function resultLengthFirstScore(r){
      // v10.6: the confidence view is a presentation ranking, not a pure
    ...
    function rowConfidenceCompare(settings){
      return (a,b)=>{
        // v10.6: length/clarity is primary both inside a module and when
