...
assert.ok(AI_STYLES.every(style => style.maxDepth >= 40 || style.id === 'balanced'), 'v17.1 styles should keep high depth ceilings');
console.log('v17.1 AI pause/style and mate-order tests passed.');
