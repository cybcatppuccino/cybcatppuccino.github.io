...
assert.match(html, /Orion JS 19\.5/);
assert.match(html, /app\.js\?v=19\.5/);
assert.match(app, /gardner-current-game-v19\.5/);
assert.match(app, /gardner-current-game-v19\.2/);
assert.match(app, /gardner-current-game-v19\.1/);
assert.match(cache, /gardner-analysis-cache-v19\.5/);
assert.match(cache, /gardner-analysis-cache-v19\.2/);
assert.match(cache, /gardner-analysis-cache-v19\.1/);

console.log('v19.5 MultiPV PV reconstruction and versioning tests passed.');
