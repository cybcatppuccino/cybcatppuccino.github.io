...
assert.doesNotMatch(worker, /shouldDeferTablebasePseudoDisplay|flushDeferredTablebaseDisplay/, 'v19.8 does not splice a pseudo-score display into the stable result pipeline.');
...
console.log('v19.8 exact-tablebase handoff and display-priority tests passed.');
