...
assert.match(html, /Gardner MiniChess Lab v17/, 'visible app version should be v17');
assert.match(html, /Orion JS 17/, 'default engine label should be Orion JS 17');
...
assert.match(cacheSource, /Orion JS 15\.2/, 'v17 cache migration should still accept v15.2 Orion analysis entries');
...
assert.equal(partial.engine, 'Orion JS 17');
...
console.log('v17 live top-three analysis information tests passed.');
