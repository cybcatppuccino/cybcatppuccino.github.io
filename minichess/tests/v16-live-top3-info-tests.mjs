...
assert.match(html, /Gardner MiniChess Lab v17.1/, 'visible app version should be v17.1');
assert.match(html, /Orion JS 17.1/, 'default engine label should be Orion JS 17.1');
...
assert.match(cacheSource, /Orion JS 15\.2/, 'v17.1 cache migration should still accept v15.2 Orion analysis entries');
...
assert.equal(partial.engine, 'Orion JS 17.1');
...
console.log('v17.1 live top-three analysis information tests passed.');
