...
assert.match(html, /Gardner MiniChess Lab v18.2/, 'visible app version should be v18');
assert.match(html, /Orion JS 18.2/, 'default engine label should be Orion JS 18.2');
...
assert.match(cacheSource, /gardner-analysis-cache-v18.2/, 'v18.2 cache should use a fresh v18.2 bucket');
assert.match(cacheSource, /gardner-analysis-cache-v17\.4/, 'v18.2 cache should explicitly retire stale v17.4 buckets');
...
assert.equal(partial.engine, 'Orion JS 18.2');
...
console.log('v18.2 live top-three analysis information tests passed.');
