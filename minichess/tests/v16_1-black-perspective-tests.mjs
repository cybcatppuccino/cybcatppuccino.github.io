...
assert.match(engineSource, /Orion JS 17/, 'engine version should be v17');
...
assert.equal(direct.engine, 'Orion JS 17');
...
console.log('v17 black-perspective ordering tests passed.');
