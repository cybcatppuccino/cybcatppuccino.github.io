...
assert.match(engineSource, /Orion JS 16\.1/, 'engine version should be v16.1');
...
assert.equal(direct.engine, 'Orion JS 16.1');
...
console.log('v16.1 black-perspective ordering tests passed.');
