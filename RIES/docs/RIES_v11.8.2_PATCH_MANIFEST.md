# RIES v11.8.2 patch manifest

This patch is intended to be applied on top of the complete v11.8.1 build.
...
- `changelog/RIES_v11.8.2_CHANGELOG.md`
- `docs/RIES_v11.8.2_PATCH_MANIFEST.md`
