...
- `ries.html` — browser RIES-lite v6.1 page with level up to 9, exact integer shortform search up to effort 7, richer structured integer database families, tiny pretty-residual database, decimal/complex algebraic-number recognition, high-precision expression evaluation, and bounded integer factorization.
