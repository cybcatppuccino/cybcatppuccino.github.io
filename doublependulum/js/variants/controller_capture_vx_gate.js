...
export class PendulumController {
  ...
  update(state, params, dt, t) {
    ...
    if (escapeActive) {
      ...
      if (near.angleNorm < captureStartAngle && near.speedNorm < captureStartSpeed && Math.abs(state.vx) < 1.80 && supportEdgeRatio(state, params) < 0.72) this.localCaptureActive = true;
