...
function robustLocalAcceleration(state, target, params, lqrA) {
  ...
  const localCapBase = params.maxAcc <= 20 ? Math.min(params.maxAcc, 6.0 + 5.0 * angleNorm + 1.8 * speedNorm) : Math.min(params.maxAcc, ((params.friction || 0) >= 0.04 ? 6.0 : 5.2) + ((params.friction || 0) >= 0.04 ? 5.0 : 5.0) * angleNorm + ((params.friction || 0) >= 0.04 ? 3.0 : 1.25) * speedNorm);
