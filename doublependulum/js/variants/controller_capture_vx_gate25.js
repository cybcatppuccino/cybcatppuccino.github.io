...
export class PendulumController {
  ...
  update(state, params, dt, t) {
    ...
    if (escapeActive) {
      ...
      if (near.angleNorm < captureStartAngle && near.speedNorm < captureStartSpeed && Math.abs(state.vx) < 2.50 && supportEdgeRatio(state, params) < 0.78) this.localCaptureActive = true;
