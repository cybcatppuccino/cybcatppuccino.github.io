...
function predictiveLandingGuardAcceleration(state, raw, target, params, near) {
  ...
  const angleLimit = target.id === 3 ? (highAuthority ? 0.72 : 0.68) : (highAuthority ? 0.30 : 0.23);
  const speedLimit = target.id === 3 ? (highAuthority ? 5.40 : 4.80) : (highAuthority ? 2.70 : 1.70);
