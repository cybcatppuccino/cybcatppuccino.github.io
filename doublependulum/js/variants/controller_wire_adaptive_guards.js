...
export class PendulumController {
  ...
  update(state, params, dt, t) {
    ...
    if (specialState3AIActive && this.aiProfile) {
      ...
      raw = adaptiveCaptureBrakeAcceleration(state, raw, this.target, params, preNear, this.aiProfile);
      raw = adaptiveEdgeReserveAcceleration(state, raw, this.target, params, preNear, this.aiProfile);
