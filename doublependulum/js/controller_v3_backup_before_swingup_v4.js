...
function makeLqrGain(target, params) {
  ...
  const state3BrakeWeightedVelocity = (params.friction || 0) >= 0.065 && authorityAbove(params, 20) >= 0.5 && authorityBelow(params, 24) >= 0.5 ? 0.46 : 0.80;
  const qCartVelocity = target.id === 0 ? 4.6 : (target.id === 3 ? state3BrakeWeightedVelocity : 1.65);
