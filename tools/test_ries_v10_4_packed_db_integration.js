...
(async()=>{
  ...
  if(!sandbox.RIES_SHORTFORM_100K_PACKED || sandbox.RIES_SHORTFORM_100K_PACKED.version!=='10.4') throw new Error('Packed DB was not installed with v10.4.');
  ...
  console.log('PASS RIES v10.4 packed DB integration test');
