// RIES v9.6 sorting-only length-first confidence smoke test.
const fs = require('fs');
const vm = require('vm');
...
if(!html.includes('RIES <em>v9.6</em>')) throw new Error('ries.html version should be v9.6.');
...
console.log('PASS RIES v9.6 length-first confidence sorting smoke test');
