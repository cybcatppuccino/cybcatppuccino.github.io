// RIES v9.4 decimal precision policy smoke/stress test.
const fs = require('fs');
const vm = require('vm');
const {performance} = require('perf_hooks');
const Decimal = require('../assets/decimal.js');
const html = fs.readFileSync('ries.html','utf8');
if(!html.includes('RIES <em>v9.4</em>')) throw new Error('ries.html was not updated to v9.4.');
...
if(!test || !logTest) throw new Error('v9.4 precision/log test exports missing.');
...
(async()=>{
  ...
  console.log('PASS RIES v9.4 typed precision policy/log/L-function smoke test');
