// RIES v10.5 regression: after all async modules complete, confidence order
...
if(!fs.readFileSync('ries.html','utf8').includes('RIES <em>v10.5</em>')) throw new Error('ries.html version should be v10.5.');
console.log('PASS RIES v10.5 confidence final module sorting test');
