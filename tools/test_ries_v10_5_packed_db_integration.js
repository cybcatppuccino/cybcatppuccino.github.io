...
(async()=>{
  ...
  if(!sandbox.RIES_SHORTFORM_100K_PACKED || sandbox.RIES_SHORTFORM_100K_PACKED.version!=='10.5') throw new Error('Packed DB was not installed with v10.5.');
  ...
  console.log('PASS RIES v10.5 packed DB integration test');
