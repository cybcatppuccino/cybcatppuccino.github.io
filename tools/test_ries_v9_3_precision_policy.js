// RIES v9.3 decimal precision policy smoke/stress test.
const fs = require('fs');
const vm = require('vm');
...
if(!test || !logTest) throw new Error('v9.3 precision/log test exports missing.');
...
(async()=>{
  ...
  console.log('PASS RIES v9.3 typed precision policy/log/L-function smoke test');
