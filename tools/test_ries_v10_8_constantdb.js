// RIES v10.8.1 regression: low-precision constant database module.
const fs = require('fs');
const vm = require('vm');
...
if(!html.includes('assets/constantdb300.js?v=10.8.1')) throw new Error('ries.html should load constantdb300.js v10.8.1');
console.log('PASS RIES v10.8.1 constant database module');
