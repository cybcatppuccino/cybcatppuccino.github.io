...
(async()=>{
  ...
  if(!sandbox.RIES_SHORTFORM_100K_PACKED || sandbox.RIES_SHORTFORM_100K_PACKED.version!=='10.8') throw new Error('Packed DB was not installed with v10.8.');
  ...
  console.log('PASS RIES v10.8 packed DB integration test');
