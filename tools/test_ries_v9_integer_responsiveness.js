...
if(!html.includes('RIES <em>v9</em>')) throw new Error('ries.html was not updated to v9.');
...
(async()=>{
  ...
  console.log('PASS RIES v9 integer responsiveness/cache/cleanup smoke test');
