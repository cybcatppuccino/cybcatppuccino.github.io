// RIES v9.3 target-change state reset and log|c| smoke/stress test.
const fs = require('fs');
const vm = require('vm');
...
if(!logTest || typeof logTest.resetSearchFrameworkForInputChange!=='function') throw new Error('v9.3 reset/log test exports missing.');
...
(async()=>{
  ...
  console.log('PASS RIES v9.3 state reset/log/integer smoke test');
