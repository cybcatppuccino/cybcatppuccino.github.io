...
if(!html.includes('RIES <em>v11.1.1</em>')) throw new Error('ries.html visible version should be v11.1.1');
if(!html.includes('assets/constantdb300.js?v=11.1.1')) throw new Error('constant DB cache-buster should be v11.1.1');
if(!html.includes('ries-script.js?v=11.1.1')) throw new Error('ries-script cache-buster should be v11.1.1');
...
console.log('PASS RIES v11.1.1 constant database budgets, precision gate, latex, algebraic π, and false-positive guard tests');
process.exit(0);
