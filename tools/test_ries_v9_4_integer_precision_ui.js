// RIES v9.4 integer responsiveness, substring DB, and no precision-controls smoke test.
const fs = require('fs');
const vm = require('vm');
...
(async()=>{
  ...
  console.log('PASS RIES v9.4 integer responsiveness, substring DB, and no precision-controls smoke test');
