...
assert(html.includes('RIES <em>v11.8.2</em>'), 'RIES navbar should advertise v11.8.2');
assert(html.includes('ries-script.js?v=11.8.2'), 'ries.html should cache-bust ries-script.js with v11.8.2');
...
console.log('PASS RIES v11.8.2 integral/sum packaging regression test');
