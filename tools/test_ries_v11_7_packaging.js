...
assert(html.includes('RIES <em>v11.7.2</em>'), 'RIES navbar should advertise v11.7.2');
assert(html.includes('ries-script.js?v=11.7.2'), 'ries.html should cache-bust ries-script.js with v11.7.2');
...
console.log('PASS RIES v11.7.2 integral/sum packaging test');
