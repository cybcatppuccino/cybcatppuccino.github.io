...
assert(html.includes('RIES <em>v11.8.1</em>'), 'RIES navbar should advertise v11.8.1');
assert(html.includes('ries-script.js?v=11.8.1'), 'ries.html should cache-bust ries-script.js with v11.8.1');
...
console.log('PASS RIES v11.8.1 integral/sum packaging regression test');
