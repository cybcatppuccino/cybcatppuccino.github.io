// RIES v8.6 startup/static-deploy smoke test.
// Run from repository root: node tools/test_ries_v8_6_startup.js
const fs = require('fs');
const vm = require('vm');
...
for(const token of ['RIES <em>v9.2</em>','id="resultTools"','id="sortConfidenceBtn"','script defer src="ries-script.js"']){
...
if(listenerCount < 7) throw new Error('Expected v8.6 UI listeners, including sort buttons, were not attached.');
console.log('PASS RIES v8.6 startup/static-deploy smoke test');
