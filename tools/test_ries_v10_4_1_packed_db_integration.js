...
(async()=>{
  ...
  if(!sandbox.RIES_SHORTFORM_100K_PACKED || sandbox.RIES_SHORTFORM_100K_PACKED.version!=='10.4.1') throw new Error('Packed DB was not installed with v10.4.1.');
  ...
  console.log('PASS RIES v10.4.1 packed DB integration test');
