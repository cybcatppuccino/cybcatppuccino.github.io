...
assert(html.includes('RIES <em>v11.7.4</em>') && html.includes('ries-script.js?v=11.7.4'), 'v11.7.4 page/cache-buster missing');
console.log('PASS RIES v11.7.4 comprehensive LaTeX normalization regression test');
