...
assert(html.includes('RIES <em>v11.8</em>') && html.includes('ries-script.js?v=11.8'), 'v11.8 page/cache-buster missing');
console.log('PASS RIES v11.8 comprehensive LaTeX normalization regression test');
