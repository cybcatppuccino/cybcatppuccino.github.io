...
(async()=>{
  ...
  if(!sandbox.RIES_SHORTFORM_100K_PACKED || sandbox.RIES_SHORTFORM_100K_PACKED.version!=='10.3') throw new Error('Packed DB was not installed with v10.3.');
  ...
  console.log('PASS RIES v10.3 packed DB integration test');
