// RIES v10.9.1 regression: prioritized constant database algebraic multiples of π
...
if(sandbox.RIES_CONSTANT_DB_300_VERSION !== '10.9.1') throw new Error('constant DB version should be 10.9.1');
const html=fs.readFileSync('ries.html','utf8');
if(!html.includes('RIES <em>v10.9.1</em>')) throw new Error('ries.html version should be v10.9.1');
if(!html.includes('assets/constantdb300.js?v=10.9.1')) throw new Error('constant DB cache-buster should be v10.9.1');
if(!html.includes('ries-script.js?v=10.9.1')) throw new Error('ries-script cache-buster should be v10.9.1');
...
console.log('PASS RIES v10.9.1 constant database algebraic π and 8-row output');
