// RIES v10.4.1 regression: after all async modules complete, confidence order
...
if(!fs.readFileSync('ries.html','utf8').includes('RIES <em>v10.4.1</em>')) throw new Error('ries.html version should be v10.4.1.');
console.log('PASS RIES v10.4.1 confidence final module sorting test');
