...
(async()=>{
  ...
  if (!sandbox.RIES_SHORTFORM_100K_PACKED || sandbox.RIES_SHORTFORM_100K_PACKED.version!=='10.3') throw new Error('packed DB version is not 10.3');
  ...
  console.log('PASS RIES v10.3 integer validation and 768 regression test');
