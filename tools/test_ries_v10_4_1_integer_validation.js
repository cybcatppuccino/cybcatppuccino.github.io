...
(async()=>{
  ...
  if (!sandbox.RIES_SHORTFORM_100K_PACKED || sandbox.RIES_SHORTFORM_100K_PACKED.version!=='10.4.1') throw new Error('packed DB version is not 10.4.1');
  ...
  console.log('PASS RIES v10.4.1 integer validation and 768 regression test');
