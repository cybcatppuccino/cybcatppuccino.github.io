    ...
    const hpFunctionNames=new Set(['sqrt','sin','cos','tan','log','ln','exp','abs','gamma']);
    ...
    async function solve(){
      ...
      try{
        ...
        setSearchStatus(runHighPrecisionAlg ? 'Checking logarithmic combinations and final ranking…' : 'Skipping high-precision algebraic reconstruction for this input; checking RIES/log results…', .82, 'final pass');
        await nextPaint();
